...
COMMENT ON TABLE tgpsdata IS '������ GPS';
COMMENT ON COLUMN tgpsdata.dsysdata IS '��������� (���������) ���� ������';
COMMENT ON COLUMN tgpsdata.ddata IS '���� GPS';
COMMENT ON COLUMN tgpsdata.ntime IS '����� GPS � �������� �� ������ �����';
COMMENT ON COLUMN tgpsdata.cimei IS 'IMEI ��� ID ����������';
COMMENT ON COLUMN tgpsdata.nstatus IS '��������� ���������� GPS';
COMMENT ON COLUMN tgpsdata.nlongitude IS '������� � ����� ��������';
COMMENT ON COLUMN tgpsdata.cew IS '���� ������� E/W';
COMMENT ON COLUMN tgpsdata.nlatitude IS '������ � ����� ��������';
COMMENT ON COLUMN tgpsdata.cns IS '���� ������ N/S';
COMMENT ON COLUMN tgpsdata.naltitude IS '������, �����';
COMMENT ON COLUMN tgpsdata.nspeed IS '��������, ��/� (1���� = 1.852 km)';
COMMENT ON COLUMN tgpsdata.nheading IS '����������� �������� (������)';
COMMENT ON COLUMN tgpsdata.nsat IS '���-�� ���������';
COMMENT ON COLUMN tgpsdata.nvalid IS '0-�������������� ������, 1-�����';
COMMENT ON COLUMN tgpsdata.nnum IS '���������� � ������ GPS';
COMMENT ON COLUMN tgpsdata.nvbort IS '���������� ��������';
COMMENT ON COLUMN tgpsdata.nvbat IS '���������� ������� ����������';
COMMENT ON COLUMN tgpsdata.ntmp IS '����������� ����������';
COMMENT ON COLUMN tgpsdata.nhdop IS 'HDOP';
COMMENT ON COLUMN tgpsdata.nout IS '������� ���� ��������� ����������� ��������� (�������)';
COMMENT ON COLUMN tgpsdata.ninp IS '������� ���� ��������� �������� (������)';
COMMENT ON COLUMN tgpsdata.nin0 IS '��������� ������� (�����) � 1';
COMMENT ON COLUMN tgpsdata.nfuel1 IS '��������� ������� ������ ������� � 1';
COMMENT ON COLUMN tgpsdata.nprobeg IS '������, ����������� ����������';
COMMENT ON COLUMN tgpsdata.nzaj IS '��������� ���������';
COMMENT ON COLUMN tgpsdata.nalarm IS '��������� ������ �������';
COMMENT ON COLUMN tgpsdata.nprobegc IS '������, ����������� ��������, �����';
